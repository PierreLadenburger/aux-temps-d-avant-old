        ...
        <div class="row" style="padding-top: 8rem !important">
                ...
                <div class="col-sm-9 col-md-9 col-lg-10">
                    ...
                    try  {
                        ...
                        $rep = $bdd->query('SELECT * FROM reservations WHERE chambre=\'forge\' ORDER BY date ASC');
                        foreach ($rep as $repBis)
                        {
                            echo '<tr>';
...
<script>
    ...
    $(document).on('click', '#add', function() {
        ...
        if (prenom !== '' && nom !== '' && dateStart !== '' && dateEnd !== '')        {
            var dataString = 'chambre=FORGE&prenom=' + prenom + '&nom=' + nom + "&dateStart=" + dateStart + "&dateEnd=" + dateEnd + "&type=add";
